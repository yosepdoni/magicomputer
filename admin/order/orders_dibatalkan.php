          ...
          <div class="col-12">
           ...
           <div class="box-body">
              ...
              <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                 ...
                 <caption>Pesanan dibatalkan</caption>
                <thead>
                  <tr>
                    <th>Id</th>
                  ...
                  <tbody>
                  <?php
                  $data = mysqli_query($conn, "SELECT * FROM pesanan WHERE status_kirim ='dibatalkan' ORDER BY id_pesanan ASC limit 50");
                  $no =1;
                  while($d = mysqli_fetch_array($data)){
                ?>
                  <tr> 
                    <td><?php echo $no++;?></td>
                    <td><p class="card-text m-1" style="white-space: pre-wrap;"><?=substr($d['daftar_pesanan'], 0,90); ?> ...</p></td>
                    ...
                    <td><?= $d['tanggal']; ?></td>
                    <td>
                      <a href="index.php?p=detailorder&id_pesanan=<?=$d['id_pesanan'];?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
