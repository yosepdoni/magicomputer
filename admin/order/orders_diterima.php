          ...
          <div class="col-12">
           ...
           <div class="box-body">
              ...
              <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                 ...
                 <caption>Pesanan diterima</caption>
                <thead>
                  <tr>
                    <th>Id</th>
                    <th>No Resi</th>
                  ...
                  <tbody>
                  <?php
                  $data = mysqli_query($conn, "SELECT * FROM pesanan WHERE status_kirim ='diterima' ORDER BY id_pesanan ASC limit 50");
                  $no =1;
                ...
                ?>
                  <tr> 
                    ...
                    <td>
                      <a href="index.php?p=detailorder_diterima&id_pesanan=<?=$d['id_pesanan'];?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                    </td>
                  </tr>
                  <?php
