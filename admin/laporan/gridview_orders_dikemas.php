                  ...
                  <div id="printableArea" class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                      <form action="" method="GET">
                          ...
                          <caption>
                            <div>Laporan penjualan / pesanan sedang dikemas <p style="float:right;">Kasir: <?= $session_nama;?></p></div>
                          </caption>
                    ...
                    <!-- <p>Laporan: <?php echo $tanggal_awal . " sampai tanggal " . $tanggal_akhir ?></p> -->
