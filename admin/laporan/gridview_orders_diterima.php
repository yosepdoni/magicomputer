                  ...
                  <div id="printableArea" class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
                      <form action="" method="GET">
                        <caption>
                          <div>Laporan penjualan / pesanan diterima <p style="float:right;">Kasir: <?= $session_nama; ?></p>
                          </div>
                        </caption>
                        <thead>
                          <tr>
                        ...
                        <tbody>
                          ...
                          if (isset($_POST['pencarian'])) {
                            ...
                            $tanggal_akhir = $_POST['ke'];
                            // tampilkan data yang sesuai dengan range tanggal yang dicari 
                            $data = mysqli_query($conn, "SELECT * FROM pesanan WHERE tanggal BETWEEN '$tanggal_awal' and '$tanggal_akhir' AND status_kirim ='diterima'");
                          } else {
                            // $data = mysqli_query($conn, "select * from checkout ORDER BY order_id ASC");
                            $data = mysqli_query($conn, "SELECT * FROM pesanan WHERE status_kirim ='diterima' ORDER BY id_pesanan ASC");
                          }
                          $no = 1;
                          ...
                          ?>
                            <tr>
                              ...
                              <td><?= $d['no_resi']; ?></td>
                              <td>
                                <p class="card-text"><?= $d['daftar_pesanan']; ?></p>
                              </td>
