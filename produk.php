...
<script>
    function filterCards() {
        ...
        cards.forEach((card) => {
            ...
            if (
                (selectedCategory === "Pilih Kategori" || selectedCategory === cardCategory) &&
...
<div class="col-lg-5 mx-auto my-4 d-flex justify-content-lg-center">
    <input id="filter" type="search" placeholder="Cari Produk" aria-label="Search" autocomplete="off" class="form-control">
</div>
<div class="col-lg-5 mx-auto my-4 d-flex justify-content-lg-center">
    ...
    <div class="row justify-content-lg-center" id="mycard"> <!-- Added the "id" attribute to the container -->
        ...
        ?>
            ...
            <div class="col-6 col-md-2 mb-2 card mx-1"> <!-- Added the "card" class here -->
                ...
                <a href="produk_detail/<?= $h['id_produk']; ?>" class="mycard-link">
                    ...
                    <div class="card-body text-center nav-text-mycss">
                        ...
                        <div class="my-2">
                        <a href="produk_detail/<?=$h['id_produk'];?>" class="btn btn-primary" style="color: white; font-weight: bold; text-decoration: none;">Detail</a>
                        </div>
                    </div>
                </a>
